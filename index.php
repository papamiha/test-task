	...
	<head>
	  ...
	  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
		...
		<style type="text/css">
			...
			.cabinet-form-wrap:hover .cabinet-form {
				opacity: 1;
				visibility: visible;
				animation: shiver 0.4s ease;
			}
			...
			.cabinet-form__tabs-tab:hover,
			.cabinet-form__tabs-tab:focus {
				color: #0c64ac;
				text-decoration: none;
			}

			.cabinet-form__tabs-tab--active {
				font-weight: bold;
				border-color: currentColor;
			}

			.cabinet-form__fieldset {
				display: flex;
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse">
		      <ul class="nav navbar-nav">
		        <li class="cabinet-form-wrap">
							<a href="#">Кабінет</a>

							<div class="cabinet-form">
								<div class="cabinet-form__tabs mb-24">
									<a href="#" class="cabinet-form__tabs-tab cabinet-form__tabs-tab--active">First Name</a>
									<a href="#" class="cabinet-form__tabs-tab">Settings</a>
								</div>

								<form>
									<div class="cabinet-form__fieldset">
										<div class="cabinet-form__field">
											<label class="cabinet-form__field-label" for="firstName">Label</label>
											<input class="cabinet-form__field-input" id="firstName" type="text" placeholder="First Name" />
										</div>
										<div class="cabinet-form__field">
											<label class="cabinet-form__field-label" for="secondName">Placeholder</label>
											<input class="cabinet-form__field-input" id="secondName" type="text"  />
										</div>
										<div class="cabinet-form__field">
											<p class="cabinet-form__field-label">Required</p>
											<label for="required" class="custom-checkbox">
												<input id="required" class="custom-checkbox__input" type="checkbox" />
								...
								<?php foreach ($categories as $category): ?>
									<?php if ($category === 'Комп`ютери'): ?>
										<li class="dropdown-submenu">
											<a href="#" class="text-ellipsis"><?php echo htmlspecialchars($category); ?> <span class="caret rotate-270"></span></a>
											<ul class="dropdown-menu">
												<?php foreach ($sub_categories as $sub): ?>
													<li><a href="#" class="text-ellipsis"><?php echo htmlspecialchars($sub); ?></a></li>
												<?php endforeach; ?>
											</ul>
										</li>
									<?php else: ?>
										<li><a href="#" class="text-ellipsis"><?php echo htmlspecialchars($category); ?></a></li>
									<?php endif; ?>
								<?php endforeach; ?>
		          </ul>
		        </li>
